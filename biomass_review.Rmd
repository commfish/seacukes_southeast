...
## Error structure?
After some review of the raw data and calculations, the current error strucutre, using a normal distribution, is adequate for describing the error around density estimates.  However, a normal distribution does not 
